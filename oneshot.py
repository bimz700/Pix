...
class Companion:
    ...
    def __init_wpa_supplicant(self):
        print('[*] Menjalankan wpa_supplicant…')
    ...
    def iw_scanner(self) -> Dict[int, dict]:
        ...
        if self.vuln_list:
            print('Tanda Jaringan: {1} {0} {2} {0} {3}'.format(
                '|',
                colored('Mungkin rentan', color='green'),
                colored('WPS Terkunci', color='red'),
                colored('Sudah Disimpan', color='yellow')
            ))
        print(' By Bimz')
        print(' list Jaringan:')
        ...
        try:
            ...
            if args.pbc:
                ...
                if not args.bssid:
                    ...
                    if not args.loop:
                        print('[*] BSSID tidak spesifik (--bssid) — scan jaringan yang tersedia')
